/**
 * MIGRATION EXAMPLE: UserProfileTab using unified view/edit components
 * 
 * This example shows how to migrate UserProfileTab.tsx to use the new unified
 * ViewEditForm, useViewEditForm hook, and ViewEditField components.
 * 
 * Key improvements:
 * 1. Unified state management with useViewEditForm hook
 * 2. Consistent field rendering with ViewEditField components  
 * 3. Standardized save/cancel/validation logic
 * 4. Proper error handling and success messaging
 * 5. Eliminates duplicate view/edit rendering logic
 */
...
interface UserProfileTabMigratedProps {
  user: User;
  onUserUpdate: (user: User) => void;
}

const UserProfileTabMigrated: React.FC<UserProfileTabMigratedProps> = ({ 
  user, 
  onUserUpdate 
}) => {
...
export default UserProfileTabMigrated;
